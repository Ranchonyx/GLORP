...
function encodeInteger(integer) {
    function encodePositiveInteger(positiveInteger) {
    ...
    function encodeNegativeInteger(negativeInteger) {
...
export function encodeNumber(x) {
    if (typeof x === "bigint")
...
//# sourceMappingURL=NumberEncoder.js.map